TOMANDO DATOS DEL WASHINGTON POST SOBRE LOS ASESINATOS POLICIALES EN ESTADOS UNIDOS EN LOS ULTIMOS AÑOS, SE COMPARARON LOS AÑOS ELECTORALES PONIENDO FOCO LOS ESTADOS DE WISCONSIN, GEORGIA, PENSILVANIA,Y MICHIGAN.
